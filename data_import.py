...
# Read the text file
df_exam = pd.read_fwf('./data/exams', widths=col_widths, names=col_names)
...
df_st = pd.read_fwf('./data/students', widths=col_widths, names=col_names)
# Print the dataframe
#print(df_st)
...
df_en = pd.read_fwf('./data/enrolements', widths=col_widths, names=col_names)
# Print the dataframe
#print(df_en)
...
hours_keys = {'23-01-1995': [0, 1, 2],
              ...
              '11-02-1995': [47],
              '13-02-1995': [48, 49, 50]}
mondays = ['23-01-1995', '30-01-1995', '06-02-1995', '13-02-1995']
